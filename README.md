...
- **Beautiful Output** - Rich terminal UI with consistent color coding per pod
...
|----------|-------|------|---------|-------------|
| `--namespace` | `-n` | str | context | Comma-separated list of namespaces |
...
KuLo displays logs in a structured format:
